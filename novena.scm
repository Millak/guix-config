    ...
    (cons* (service openssh-service-type
           ...
           (service tailscaled-service-type
                    (tailscaled-configuration
                      (package (specification->package "tailscale-bin-arm"))))
...
;; guix system image --image-type=novena-raw -L ~/workspace/my-guix/ -L ~/workspace/guix-config/ ~/workspace/guix-config/novena.scm --system=armhf-linux
;; guix system image --image-type=novena-raw -L ~/workspace/my-guix/ -L ~/workspace/guix-config/ ~/workspace/guix-config/novena.scm --target=arm-linux-gnueabihf
